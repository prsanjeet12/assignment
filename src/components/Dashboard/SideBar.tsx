...
const Sidebar: React.FC = () => {
  return (
    <div className="bg-[#011627] h-[984px]
     w-full md:w-64 top-[40px] left-0 border-[#011627] 
    rounded-r-[32px]  flex-col hidden sm:hidden lg:flex md:hidden"> {/* Add hidden classes for small and medium screens */}
